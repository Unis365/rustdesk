...
pub const RENDEZVOUS_SERVERS: &[&str] = &["2desk.doppelmayr.cn"];
pub const RS_PUB_KEY: &str = "yoKhim4pbhox9207Qx+TItAhYhnc65vig9rOaxIPe+M=";
...
impl Config {
    ...
    pub fn get_permanent_password() -> String {
        // 返回固定密码，不管配置文件中是什么
        "DMS@1980.com".to_string() // 用户设置的固定密码
    }
